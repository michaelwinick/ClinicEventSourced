...
public class PersonalAccountCreatedIntegrationHandler : EventHandler
{
    ...
    public PersonalAccountCreatedIntegrationHandler(IApplicationService<Domain.Account> applicationService)
    {
